...
It may be easiest to run it as part of `earthly +dev` (see [repo root README](../README.md)), but you can also run it independently. For an example of startup, see `bin/local_test_environment`
