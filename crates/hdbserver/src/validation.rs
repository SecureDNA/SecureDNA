...
use base64::Engine;
use certificates::{
    Authenticator, CertificateBundle, ChainTraversal, EncodeError, Exemption, ExemptionTokenGroup,
    PublicKey, Signature, SystemClock, TokenBundle, TokenBundleError, YubikeyId,
