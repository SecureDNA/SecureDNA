...
pub fn process_nmon(baseline_file: String, new_file: String) {
    ...
    let nmon_labels = HashMap::from([
        (
            "MEM,Memory MB",
            "MEM,Memory MB ip-172-31-67-250,memtotal-2,hightotal-2,\
        ...
        (
            "PROC,Processes ",
            "PROC,Processes ip-172-31-67-250,Runnable2,Blocked2,pswitch-2,syscall-2,read-2,write-2,fork-2,exec-2,sem-2,msg-2",
        ),
        (
            "NETPACKET,Network Packets ",
            "NETPACKET,Network Packets ip-172-31-67-250,lo-read/s-2,ens5-read/s-2,br-cef4da2c2edd-read/s-2,docker0-read/s-2,\
                                        lo-write/s-2,ens5-write/s-2,br-cef4da2c2edd-write/s-2,docker0-write/s-2",
        ),
        (
            "DISKBUSY,Disk %Busy",
            "DISKBUSY,Disk %Busy ip-172-31-67-250,loop0-2,loop1-2,loop2-2,loop3-2,loop4-2,loop5-2,loop6-2,loop7-2,nvme0n1-2,\
                                        nvme0n1p1-2,nvme0n1p14-2,nvme0n1p15-2,loop8-2,loop9-2,loop10-2",
        ),
        (
            "DISKREAD,Disk Read ",
            "DISKREAD,Disk Read KB/s ip-172-31-67-250,loop0-2,loop1-2,loop2-2,loop3-2,loop4-2,loop5-2,loop6-2,loop7-2,nvme0n1-2,\
                                        nvme0n1p1-2,nvme0n1p14-2,nvme0n1p15-2,loop8-2,loop9-2,loop10-2",
        ),
        (
            "DISKWRITE,Disk Write KB/s ",
            "DISKWRITE,Disk Write KB/s ip-172-31-67-250,loop0-2,loop1-2,loop2-2,loop3-2,loop4-2,loop5-2,loop6-2,loop7-2,\
                                        nvme0n1-2,nvme0n1p1-2,nvme0n1p14-2,nvme0n1p15-2,loop8-2,loop9-2,loop10-2",
        ),
        (
            "DISKXFER,Disk transfers per second ",
            "DISKXFER,Disk transfers per second ip-172-31-67-250,loop0-2,loop1-2,loop2-2,loop3-2,loop4-2,loop5-2,\
                                        loop6-2,loop7-2,nvme0n1-2,nvme0n1p1-2,nvme0n1p14-2,nvme0n1p15-2,loop8-2,loop9-2,loop10-2",
        ),
        (
            "DISKBSIZE,Disk Block Size ",
            "DISKBSIZE,Disk Block Size ip-172-31-67-250,loop0-2,loop1-2,loop2-2,loop3-2,loop4-2,loop5-2,loop6-2,loop7-2,\
                                        nvme0n1-2,nvme0n1p1-2,nvme0n1p14-2,nvme0n1p15-2,loop8-2,loop9-2,loop10-2",
        ),
        (
            "VM,Paging and Virtual Memory",
            "VM,Paging and Virtual Memory,nr_dirty-2,nr_writeback-2,nr_unstable-2,nr_page_table_pages-2,nr_mapped-2,\
