    ...
    <>
      {props.small ? (
        ...
        <button
          ...
          onDragEnd={onDrag}
          onDrop={onDrag}
          className={`w-36 h-36 p-4 text-center rounded-2xl flex flex-col items-center justify-center transition hover:bg-secondary hover:text-white hover:cursor-pointer ${dragging ? "bg-secondary text-white" : "bg-primary"}`}
        >
          <FontAwesomeIcon
            icon={faUpload}
            size="3x"
